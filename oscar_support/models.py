...
class Ticket(models.Model):
    ...
    parent = models.ForeignKey('oscar_support.Ticket', verbose_name=_("Parent"),
    ...
    status = models.ForeignKey('oscar_support.TicketStatus', db_index=True,
                               verbose_name=_("Status"),
                               related_name="tickets")
    type = models.ForeignKey('oscar_support.TicketType', verbose_name=_("Type"),
...
class BaseMessage(models.Model):
    ...
    ticket = models.ForeignKey('oscar_support.Ticket', verbose_name=_("Ticket"),
                               related_name="messages")
