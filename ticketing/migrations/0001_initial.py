...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ticketing_tickettype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64)),
        ))
        db.send_create_signal('ticketing', ['TicketType'])

        # Adding model 'TicketStatus'
        db.create_table('ticketing_ticketstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64)),
        ))
        db.send_create_signal('ticketing', ['TicketStatus'])

        # Adding model 'Ticket'
        db.create_table('ticketing_ticket', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64, db_index=True)),
            ('subticket_number', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subtickets', null=True, to=orm['ticketing.Ticket'])),
            ('requester', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', to=orm['ticketing.TicketStatus'])),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', to=orm['ticketing.TicketType'])),
            ...
            ('assignee', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tickets', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('ticketing', ['Ticket'])

        # Adding model 'BaseMessage'
        db.create_table('ticketing_basemessage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages', to=orm['auth.User'])),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages', to=orm['ticketing.Ticket'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('ticketing', ['BaseMessage'])

        # Adding model 'Message'
        db.create_table('ticketing_message', (
            ('basemessage_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ticketing.BaseMessage'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('ticketing', ['Message'])

        # Adding model 'Note'
        db.create_table('ticketing_note', (
            ('basemessage_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ticketing.BaseMessage'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('ticketing', ['Note'])

        # Adding model 'RelatedOrder'
        db.create_table('ticketing_relatedorder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relatedorders', to=orm['ticketing.Ticket'])),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.Order'])),
        ))
        db.send_create_signal('ticketing', ['RelatedOrder'])

        # Adding model 'RelatedLine'
        db.create_table('ticketing_relatedline', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relatedlines', to=orm['ticketing.Ticket'])),
            ('line', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.Line'])),
        ))
        db.send_create_signal('ticketing', ['RelatedLine'])

        # Adding model 'RelatedProduct'
        db.create_table('ticketing_relatedproduct', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relatedproducts', to=orm['ticketing.Ticket'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product'])),
        ))
        db.send_create_signal('ticketing', ['RelatedProduct'])

        # Adding model 'RelatedFile'
        db.create_table('ticketing_relatedfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relatedfiles', to=orm['ticketing.Ticket'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('ticketing', ['RelatedFile'])


    def backwards(self, orm):
        # Deleting model 'TicketType'
        db.delete_table('ticketing_tickettype')

        # Deleting model 'TicketStatus'
        db.delete_table('ticketing_ticketstatus')

        # Deleting model 'Ticket'
        db.delete_table('ticketing_ticket')

        # Deleting model 'BaseMessage'
        db.delete_table('ticketing_basemessage')

        # Deleting model 'Message'
        db.delete_table('ticketing_message')

        # Deleting model 'Note'
        db.delete_table('ticketing_note')

        # Deleting model 'RelatedOrder'
        db.delete_table('ticketing_relatedorder')

        # Deleting model 'RelatedLine'
        db.delete_table('ticketing_relatedline')

        # Deleting model 'RelatedProduct'
        db.delete_table('ticketing_relatedproduct')

        # Deleting model 'RelatedFile'
        db.delete_table('ticketing_relatedfile')
    ...
    models = {
        ...
        'ticketing.basemessage': {
            'Meta': {'ordering': "['-date_created']", 'object_name': 'BaseMessage'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages'", 'to': "orm['ticketing.Ticket']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages'", 'to': "orm['auth.User']"})
        },
        'ticketing.message': {
            'Meta': {'ordering': "['-date_created']", 'object_name': 'Message', '_ormbases': ['ticketing.BaseMessage']},
            'basemessage_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['ticketing.BaseMessage']", 'unique': 'True', 'primary_key': 'True'})
        },
        'ticketing.note': {
            'Meta': {'ordering': "['-date_created']", 'object_name': 'Note', '_ormbases': ['ticketing.BaseMessage']},
            'basemessage_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['ticketing.BaseMessage']", 'unique': 'True', 'primary_key': 'True'})
        },
        'ticketing.relatedfile': {
            'Meta': {'object_name': 'RelatedFile'},
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'relatedfiles'", 'to': "orm['ticketing.Ticket']"})
        },
        'ticketing.relatedline': {
            'Meta': {'object_name': 'RelatedLine'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'line': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['order.Line']"}),
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'relatedlines'", 'to': "orm['ticketing.Ticket']"})
        },
        'ticketing.relatedorder': {
            'Meta': {'object_name': 'RelatedOrder'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['order.Order']"}),
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'relatedorders'", 'to': "orm['ticketing.Ticket']"})
        },
        'ticketing.relatedproduct': {
            'Meta': {'object_name': 'RelatedProduct'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalogue.Product']"}),
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'relatedproducts'", 'to': "orm['ticketing.Ticket']"})
        },
        'ticketing.ticket': {
            'Meta': {'ordering': "['-date_updated']", 'object_name': 'Ticket'},
            'assigned_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tickets'", 'null': 'True', 'to': "orm['auth.Group']"}),
            'assignee': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tickets'", 'null': 'True', 'to': "orm['auth.User']"}),
            'body': ('django.db.models.fields.TextField', [], {}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_internal': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'number': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64', 'db_index': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'subtickets'", 'null': 'True', 'to': "orm['ticketing.Ticket']"}),
            'requester': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tickets'", 'to': "orm['ticketing.TicketStatus']"}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'subticket_number': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tickets'", 'to': "orm['ticketing.TicketType']"})
        },
        'ticketing.ticketstatus': {
            'Meta': {'object_name': 'TicketStatus'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'})
        },
        'ticketing.tickettype': {
